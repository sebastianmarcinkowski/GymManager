    ...
    public partial class Init : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, new DateTime(2022, 1, 12, 0, 0, 0, 0, DateTimeKind.Unspecified), "Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nulla nec odio nec nunc" },
                    { 2, new DateTime(2022, 1, 13, 0, 0, 0, 0, DateTimeKind.Unspecified), "Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nulla nec odio nec nunc" },
                    { 3, new DateTime(2022, 1, 14, 0, 0, 0, 0, DateTimeKind.Unspecified), "Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nulla nec odio nec nunc" },
                    { 4, new DateTime(2022, 1, 15, 0, 0, 0, 0, DateTimeKind.Unspecified), "Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nulla nec odio nec nunc" },
                    { 5, new DateTime(2022, 1, 16, 0, 0, 0, 0, DateTimeKind.Unspecified), "Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nulla nec odio nec nunc" },
                    { 6, new DateTime(2022, 1, 17, 0, 0, 0, 0, DateTimeKind.Unspecified), "Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nulla nec odio nec nunc" },
                    { 7, new DateTime(2022, 1, 18, 0, 0, 0, 0, DateTimeKind.Unspecified), "Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nulla nec odio nec nunc" },
                    { 8, new DateTime(2022, 1, 19, 0, 0, 0, 0, DateTimeKind.Unspecified), "Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nulla nec odio nec nunc" },
                    { 9, new DateTime(2022, 1, 20, 0, 0, 0, 0, DateTimeKind.Unspecified), "Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nulla nec odio nec nunc" },
                    { 10, new DateTime(2022, 1, 21, 0, 0, 0, 0, DateTimeKind.Unspecified), "Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nulla nec odio nec nunc" },
                    { 11, new DateTime(2022, 1, 22, 0, 0, 0, 0, DateTimeKind.Unspecified), "Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nulla nec odio nec nunc" },
                    { 12, new DateTime(2022, 1, 23, 0, 0, 0, 0, DateTimeKind.Unspecified), "Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nulla nec odio nec nunc" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "Host SMTP.", "HostSmtp", 1, 1, 0, "smtp.gmail.com" },
                    { 2, "Port.", "Port", 2, 1, 2, "587" },
                    { 3, "E-mail nadawcy.", "SenderEmail", 3, 1, 0, "" },
                    { 4, "Hasło nadawcy.", "SenderEmailPassword", 4, 1, 4, "" },
                    { 5, "Nazwa nadawcy.", "SenderName", 5, 1, 0, "Sebastian Marcinkowski" },
                    { 6, "Login nadawcy.", "SenderLogin", 6, 1, 0, "" },
                    { 7, "Czy wyświetlać banner na stronie głównej?", "BannerVisible", 1, 2, 1, "True" },
                    { 8, "Kolor stopki strony głównej.", "FooterColor", 2, 2, 5, "#dc3545" },
                    { 9, "Główny adres e-mail administratora.", "AdminEmail", 3, 2, 0, "kontakt@sebastianmarcinkowski.pl" }
                });
